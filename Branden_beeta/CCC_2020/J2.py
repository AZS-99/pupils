...
def spread():
    ...
    population_wanted = int(file.readline())
    starting_population = int(file.readline())
    spread_per_day = int(file.readline())
    day = 0
    while starting_population < population_wanted:
        day += 1
        starting_population += starting_population * spread_per_day
    print(day)
