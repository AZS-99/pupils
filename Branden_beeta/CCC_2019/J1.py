...
it was a tie game.
"""
def basket_calculator():
    file = open("CCC_2019/J1","r")
    apple3 = int(file.readline())
    apple2 = int(file.readline())
    apple1 = int(file.readline())
    banana3 = int(file.readline())
    banana2 = int(file.readline())
    banana1 = int(file.readline())
    apple_score = apple1 + apple2 * 2 + apple3 * 3
    banana_score = banana1 + banana2 * 2 + banana3 * 3
