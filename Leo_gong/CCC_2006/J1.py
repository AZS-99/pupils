...
def fast_food():
    ...
    drinks_dic = {1: 130, 2: 160, 3: 118, 4: 0}
    sides_dic = {1: 100, 2: 57, 3: 70, 4: 0}
    dessert_dic = {1: 167, 2: 266, 3: 75, 4: 0}
    burger_c = int(input("Please enter a burger choice: "))
    sides_c  = int(input("Please enter a side order choice: "))
    drinks_c = int(input("Please enter a drink choice: "))
    dessert_c = int(input("Please enter a dessert choice: "))

    total = burger_dic[burger_c] + sides_dic[sides_c] + drinks_dic[drinks_c] + dessert_dic[dessert_c]
