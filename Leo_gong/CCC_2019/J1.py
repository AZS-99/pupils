...
def basketball_game():
    ...
    a_three_point, a_two_points, a_one_point, b_three_points, b_two_points, b_one_point = \
        int(file.readline()), int(file.readline()), int(file.readline()), int(file.readline()), int(file.readline()), \
        int(file.readline())
    total_points_a = a_one_point + (a_two_points * 2) + (a_three_point * 3)
    total_points_b = b_one_point + (b_two_points * 2) + (b_three_points * 3)
