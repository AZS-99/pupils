...
"""
def radar():
    speed_limit, speed_car = input("Enter the speed limit: "), input("Enter the recorded spped of the car: ")
    speed_limit = int(speed_limit)
    speed_car = int(speed_car)
    if 1 <= speed_car - speed_limit <= 20:
        print("You are speeding and your fine is $100.")
    elif 21 <= speed_car - speed_limit <= 30:
        print("You are speeding and your fine is $270.")
    elif speed_car - speed_limit <= 0:
