...
def distance_cities():
    ...
    city1_2, city2_3, city3_4, city4_5 = [int(x) for x in file.readline().split(" ")]
    lst = [0, city1_2, city2_3 + city1_2, city1_2 + city2_3 + city3_4, city1_2 + city2_3 + city3_4 + city4_5]
    for i in range(5):
        for j in range(5):
            print(abs(lst[i] - lst[j]), end=" ")
        print()