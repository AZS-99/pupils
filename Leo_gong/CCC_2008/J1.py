...
"""
def bmi():
    weight, height = float(input("Enter weight: ")), float(input("Enter height: "))
    bmi = weight / (height * height)
    print("Overweight" if bmi > 25 else "", end="")
    print("Normal" if 18.5 <= bmi <= 25 else "", end="")
    print("Underweight" if bmi < 18.5 else "", end="")