...
"""
def short_form():
    abbreviation = input("Enter phrase> ")
    phrase_dic = {"CU": "See you", ":-)" : "I'm happy", ":-(" : "I'm sad", ";-)" : "wink",
              ":-P" : "sticl out the tongue", "(~.~)" : "sleepy", "TA" : "totally awesome", "CCC" : "Canadian Computation Competetion",
              "CUZ" : "because", "TY" : "thank you", "YW" : "you are welcome", "TTYL" : "talk to you latter"}
    if abbreviation in phrase_dic.keys():
        return phrase_dic[abbreviation]
    else:
        return abbreviation