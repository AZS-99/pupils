...
def fish():
    ...
    depth_one = int(file.readline())
    depth_two = int(file.readline())
    depth_three = int(file.readline())
    depth_four = int(file.readline())
    if depth_one == depth_two == depth_three == depth_four:
        return "Constant Depth"
    elif depth_one > depth_two > depth_three > depth_four:
        return "Fish Diving"
    elif depth_one < depth_two < depth_three < depth_four:
        return "Fish Rising"
    else:
