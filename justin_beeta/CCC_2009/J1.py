...
Sample Interactive Session 2 (user input shown in italics) Digit
11? 0
Digit 12? 5
Digit 13? 2
...
The 1-3-sum is 108
"""
def one_to_three_sum():
    digit_one = input("Digit 11?")
    digit_two = input("Digit 12?")
    digit_three = input("Digit 13?")
    string = "9780921418"
    string += digit_one
    string += digit_two
    string += digit_three
