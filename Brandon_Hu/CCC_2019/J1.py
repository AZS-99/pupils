...
def basketball():
    ...
    a_3points = int(file.readline())
    a_2points = int(file.readline())
    a_1point = int(file.readline())
    b_3points = int(file.readline())
    b_2points = int(file.readline())
    b_1point = int(file.readline())


    b_scores = (b_3points * 3) + (b_2points * 2) + b_1point
    a_scores = (a_3points * 3) + (a_2points * 2) + a_1point
    if b_scores < a_scores:
        print("A")
