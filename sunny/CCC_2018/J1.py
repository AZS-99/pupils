...
def sample_input():
    ...
    digit1 = int(file.readline())
    digit2 = int(file.readline())
    digit3 = int(file.readline())
    digit4 = int(file.readline())
    if digit2 == digit3 and (digit1 == 8 or digit1 == 9) and (digit4 == 8 or digit4 == 9):
        print("ignore")
    else:
        print("answer")
