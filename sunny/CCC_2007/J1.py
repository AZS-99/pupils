...
def sample_input():
    ...
    weight1 = int(file.readline())
    weight2 = int(file.readline())
    weight3 = int(file.readline())
    if weight1 < weight2 < weight3 or weight1 > weight2 > weight3:
        return weight2
    if weight2 < weight1 < weight3 or weight2 > weight1 > weight3:
        return weight1
    if weight1 < weight3 < weight2 or weight1 > weight3 > weight2:
        return weight3
