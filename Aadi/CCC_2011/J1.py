...
"""
def aliens():
    eyes = int(input("Please enter number of eyes"))
    antennas = int(input("Please enter number of antennas"))
    if eyes <= 4 and antennas >= 3:
        print("TroyMartian")
    if eyes >= 2 and antennas <= 6:
        print("VladSaturnian")
    if eyes <= 3 and antennas <= 2:
